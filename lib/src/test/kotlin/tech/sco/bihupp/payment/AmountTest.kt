...
class AmountTest {
    @Test
    fun `it creates with valid amount`() {
    ...
    @Test
    fun `it throws when exceeding max length`() {
    ...
    @Test
    fun `it accepts amount exactly at max length`() {
    ...
    @Test
    fun `it accepts leading zero number amounts`() {
    ...
    @Test
    fun `it accepts decimal amounts by stripping the decimal point`() {
