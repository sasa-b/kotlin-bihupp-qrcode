...
class PhoneNumberTest {
    @Test
    fun `it creates with valid e164 phone number`() {
    ...
    @Test
    fun `it accepts max length phone number`() {
    ...
    @Test
    fun `it strips spaces from phone number`() {
    ...
    @Test
    fun `it accepts various international country codes`() {
    ...
    @Test
    fun `it throws exception when missing leading plus`() {
    ...
    @Test
    fun `it throws exception when leading zeros without plus`() {
        assertFailsWith<IllegalStateException> {
